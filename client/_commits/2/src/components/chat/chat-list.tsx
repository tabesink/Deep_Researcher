...
const MessageToolbar = () => (
  <div className="mt-1 flex gap-3 empty:hidden juice:flex-row-reverse rounded-lg">
    <div className="text-gray-400 flex self-end lg:self-center items-center justify-center lg:justify-start mt-0 -ml-1 h-7 gap-[2px] invisible rounded-md">
...
export default function ChatList({ messages, isLoading }: ChatListProps) {
  ...
  return (
    ...
    >
      ...
      <div id="anchor" ref={bottomRef} className="h-0" />
    </div>
  );
}
